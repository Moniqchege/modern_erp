...
exports.seedSalesModuleIfNeeded = seedSalesModuleIfNeeded;
...
async function seedSalesModuleIfNeeded() {
    for (const product of PRODUCTS) {
        await server_1.prisma.salesProduct.upsert({
    ...
    for (const customer of CUSTOMERS) {
        if (customer.email) {
            await server_1.prisma.customer.upsert({
