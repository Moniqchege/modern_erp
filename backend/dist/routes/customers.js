...
exports.customersRouter.use(auth_1.requireAuth);
...
exports.customersRouter.get("/:id", (0, async_handler_1.asyncHandler)(customer_controller_1.getCustomerController));
exports.customersRouter.patch("/:id", (0, async_handler_1.asyncHandler)(customer_controller_1.updateCustomerController));
