// backend/src/modules/weighbridge/weighbridge.types.ts
...
export interface WeighbridgeDashboardQuery {
  dateFrom?: string;
  dateTo?: string;
}
...
export interface WeighbridgeTicketRecord {
  ...
  truckMaster?: { licensePlate: string; model: string; masterTareKg: number } | null;
}
